  <ol class="breadcrumb">
    ...
    <li class="active">Pengeluaran Sekolah</li>
  </ol>
<div id="myalert">
...
<div class="col-md-12">
    ...
    <div class="box-body">
      <table id="example1" class="table table-bordered table-hover">
        ...
        <td align="center">  
          ...
          <?php echo anchor('admin/pengeluaran/hapus/'.$u['id'], '<i class="fa fa-trash"></i> HAPUS', array('class'=>'delete', 'onclick'=>"return confirmDialog();")); ?>   
          </button>        
        </td>
        </tr>
        <?php $no++; } ?>
    ...
    <div class="modal-dialog modal-md" role="document">
      <div class="modal-content">
        <div class="modal-header">
          <h4 class="modal-title" id="myModalLabel" align="center">PENGELUARAN SEKOLAH
            <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span aria-hidden="true">&times;</span></button>
          </h4>
        </div>

        <div class="box-body">
          <form class="form-horizontal" method="post" action="<?php echo site_url('admin/pengeluaran/input');?>">
            <div class="box-body">
  ...
  function confirmDialog() {
    return confirm('Apakah anda yakin akan menghapus pengeluaran ini?')
  }
  </script>